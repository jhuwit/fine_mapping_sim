...
if(!dir.exists(here::here("data", "analytic"))){
...
covariates = read_csv(here("data/raw/covariates.csv")) 

cohort_event_start_stop_times = read_csv(here("data/raw/event_start_stop_times.csv")) %>% 
